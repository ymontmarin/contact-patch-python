...
def plot_convergence_history(history, title="Solver Convergence History", solver_type='PGD'):
    """
...
test_point_1 = np.array([np.float64(0.13313787264842705), np.float64(-1.8970327053422764), np.float64(1.5298530918784843), np.float64(-0.7523979653927262), np.float64(0.7800117450661668), np.float64(4.470171678520062)])
...
history_1 = []
result_1 = poly_1.project_cone(
    test_point_1,
    history=history_1
)
print(result_1)
plot_convergence_history(history_1, title="Solver Convergence History", solver_type='PGD')
